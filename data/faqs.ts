...
export const faqs: FAQ[] = [
  {
    ...
    answer: "June 22-26, 2026 at Brigham Young University in Provo, Utah.",
  },
  {
  ...
  {
    question: "Where would you recommend flying into?",
    answer: "The Salt Lake City International Airport (SLC) is the closest major airport, about a 45-minute drive to campus. However, the Provo Municipal Airport (PVU) is even closer, just a 15-minute drive, though it has fewer flight options.",
  },
];
