...
export const speakers: Speaker[] = [
  ...
  //   bio: "Venkatesan Guruswami is a Chancellor's Professor of Electrical Engineering and Computer Science, Professor of Mathematics, and Director of the Simons Institute for the Theory of Computing at the University of California, Berkeley. He received his undergraduate degree at IIT Madras and his doctorate from MIT. Venkat is a theoretical computer scientist with research interests spanning error correcting codes, approximate optimization, constraint satisfaction, computational complexity, and related mathematics. He currently serves as the Editor-in-Chief of the Journal of the ACM. A fellow of the ACM, IEEE, and AMS, his recognitions include the Presburger Award, a Simons Investigator award, Guggenheim, Packard and Sloan Fellowships, an ACM Doctoral Dissertation award, an IEEE Information Theory Society Paper award, and a distinguished alumnus award from IIT Madras.",
